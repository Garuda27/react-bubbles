...
Stores information used to validate your credentials, used for logging in

- [ ] What steps can you take in your web apps to keep your data secure?

make sure validation is secure 

- [ ] Describe how web servers work.

send receive and store data for use with webpages
